...
#             perpendicular_angle = get_angle(rect_points[1], rect_points[2])
#             move_camera((rect_points[0] + rect_points[1] + rect_points[2] + rect_points[3])/4)
#
...
#                 new_center_point = (rect_points[0]*(p+1) + rect_points[1]*(num_points-p))/(num_points+1)
...
#
#                 critical_angle1 = get_angle(act_center_point, rect_points[2])
#                 critical_angle2 = get_angle(act_center_point, rect_points[3])
#
#                 swap_index = 0
...
#                     new_circ_point = [act_center_point[0]+x_value, act_center_point[1]+y_value, act_center_point[2]]
#                     act_circ_point = find_closest_point(new_circ_point)
#                     if act_circ_point is None:
#                         print('Error finding the point ..')
#                         point_star_structure[i]['point'] = None
#                     # act_circ_point[2] += 0.2
#                     if new_angle < critical_angle1:
#                         int_point = get_xy_intersection(act_circ_point, act_center_point,
#                                                         rect_points[1+swap_index], rect_points[2-swap_index])
#                     elif new_angle < critical_angle2:
#                         int_point = get_xy_intersection(act_circ_point, act_center_point,
#                                                         rect_points[2], rect_points[3])
#                     else:
#                         int_point = get_xy_intersection(act_circ_point, act_center_point,
#                                                         rect_points[0+swap_index], rect_points[3-swap_index])
#
#                     if dist_xy(act_circ_point, act_center_point) > dist_xy(int_point, act_center_point):
#                         act_circ_point = int_point
#
#                     point_star_structure[i]['point'] = act_circ_point
#
#                     add_point(act_circ_point, size=RD_4, col='White')
#                     add_line([act_circ_point, act_center_point], width=3, col='White')
#                     point_star_structure[i]['slope'] = get_slope(act_circ_point, act_center_point)
#
#                 max_slope_index = 0
#                 max_slope_value = 0
...
#                     plt.remove(g_plot.plotted_points.pop())
#                     print(point_star_structure[i]['slope'], end=', ')
#                 print()
...
#         add_ruler([g_plot.current_points[0], mouse_point], width=3, col='yellow', size=TEXT_SIZE)
#         update_text('text3', f'Dist: {dist_xyz(g_plot.current_points[0], mouse_point):.3f}')
#         return
#
